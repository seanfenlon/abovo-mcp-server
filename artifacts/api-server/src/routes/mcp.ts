    ...
    async ({ query }) => {
      const responses: Record<string, string> = {
        capabilities: [
          ...
          "• Content the ABOVO.co email API accepts: plain text, HTML (fully rendered), images, PDFs, any file attachments",
          "• Content the publish_to_web tool can send: plain text and HTML only — the tool has no attachment parameter.",
          "  To publish a file, email it to POST@abovo.co directly rather than calling this tool.",
          "• Free to use",
        ...
        use_cases: [
          ...
          "• Share files & attachments — images, PDFs, docs all rendered on the page (email them to POST@abovo.co; publish_to_web cannot attach files)",
      ...
      contents: [
        {
          ...
          text: [
            ...
            "",
            "Over the email API (send to POST@abovo.co):",
            "",
            "- Plain text",
            "- HTML (fully rendered)",
            ...
            "- Any file attachment",
            "",
            "Through the publish_to_web tool: plain text and HTML only. The tool's input",
            "schema is subject/body/format/group and has no attachment parameter.",
            "",
